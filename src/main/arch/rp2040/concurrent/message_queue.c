...
{
  message_queue_push_internal(message_queue, message, true, NULL);
}
...
{
  message_queue_pop_internal(message_queue, message, true, NULL);
}

void message_queue_pop_with_timeout(message_queue_t* message_queue, void* message, duration_t const timeout)
{
  message_queue_pop_internal(message_queue, message, true, &timeout);
}
